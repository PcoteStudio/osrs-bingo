...
namespace Bingo.Api.Data.Migrations
{
    ...
    [Migration("20250504012250_NullableImages")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bingo.Api.Data.Entities.BoardLayerEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Bingo.Api.Data.Entities.NpcEntity", b =>
                {
                    ...
                    b.Property<double?>("KillsPerHour")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("Bingo.Api.Data.Entities.BoardLayerEntity", b =>
                {
                    b.HasOne("Bingo.Api.Data.Entities.MultiLayerBoardEntity", "Board")
                        .WithMany("Layers")
            ...
            modelBuilder.Entity("Bingo.Api.Data.Entities.TileEntity", b =>
                {
                    ...
                    b.HasOne("Bingo.Api.Data.Entities.BoardLayerEntity", null)
                        .WithMany("Tiles")
                        .HasForeignKey("BoardLayerId");
